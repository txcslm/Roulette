...
namespace Source.CodeBase.Infrastructure.Configs
{
  ...
  public class RouletteConfig : ScriptableObject
  {
    ...
    [Header("Reward Spawn Settings")] [SerializeField]
    private float _spawnRadiusMin = 50f;

    [SerializeField] private float _spawnRadiusMax = 150f;

    [Header("Object Pool Settings")] [SerializeField]
    private int _slotPoolMaxSize = 12;

    [SerializeField] private int _rewardObjectPoolMaxSize = 20;

    [Header("Reward Object Settings")] [SerializeField]
    private Vector2 _rewardObjectSize = new Vector2(70f, 70f);

    [Header("Timing Settings - Delays")] [SerializeField]
    private int _beforeSpinDelay = 500;

    [SerializeField] private int _spinProcessDelay = 1000;

    [Header("UI Settings")] [SerializeField]
    private string _tryLuckButtonText = "Испытать удачу";

    [SerializeField] private string _cooldownButtonFormat = "{0}";

    [Header("Asset Keys")] [SerializeField]
    private string _crystalIconKey = "diamond";
